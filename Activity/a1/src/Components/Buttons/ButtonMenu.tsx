...
function ButtonMenu() {
    ...
    function waterIntake() {
        navigate("/MainPage/Menu/Water")
    }
    function FoodIntake() {
        navigate("/MainPage/Menu/Food")
    }
    function Dumbel() {
        navigate("/MainPage/Menu/Dumbel")
    }
    function chemical() {
        navigate("/MainPage/Menu/Chemical")
    }
    function medicine() {
        navigate("/MainPage/Menu/Medicine")
    }
    function calendar() {
        navigate("/MainPage/Menu/Calendar")
    }
    function bp1() {
        navigate("/MainPage/Menu/BP")
    }
    function diobetic1() {
        navigate("/MainPage/Menu/Diobetic")
    }
    return (
        <div className="flex">
            <div className="p-5">
